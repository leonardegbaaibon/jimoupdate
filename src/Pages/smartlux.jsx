  ...
  return (
    <div className="body-div">
      <div className="nav-bar">     
        ...
        <ul>
  <li><b><link  to="/Project" className="pro-div">Projects</link></b></li>
  <li><b><link to="/About" className="pro-div">About Us</link></b></li>
  <li><b><link to="/Services" className="pro-div">Services</link></b></li>
  <li><b><link to="/contact" className="pro-div">Contact Us</link></b></li>
</ul>
      </div>
      <hr />.
